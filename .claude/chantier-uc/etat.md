...
| 2 | Catalogue front + listes back + CAT_MAP 4 catégories | c2.py | à faire |
| 3 | Données générées (npm run uc / fonds / ucmanagers) | c3.py | à faire |
...
Bornes git : lot 0 = « chantier UC : lot 0 » ; lot 1 = « chantier UC : lot 1 ».
